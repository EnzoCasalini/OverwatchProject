  ...
  return (
    <>
      <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
        ...
        <Typography align="center" color="#f3f4ff" fontSize="28px" sx={{ marginLeft: '10px' }}>
          {hero.name}
        </Typography>
      </Box>
      <CardMedia
        component="img"
        src={hero.portrait}
        alt={`${hero.name}'s portrait image`}
        sx={{ width: '150px', height: '150px', margin: '20px 0', borderRadius: '50%' }}
      ></CardMedia>
      <Box
      ...
      <Typography align="center" color="#f3f4ff" fontSize="16px">
        {hero.description}
      </Typography>
    </>
  )
