...
const HeroPortrait = ({heroes, heroKey}) => {
    ...
    return (
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: "30px", height: "30px", marginRight: "10px" }}>
            <img src={heroPortrait} alt={`${heroKey} portrait`} style={{ objectFit: "contain", width: "100%", height: "100%", borderRadius: "50%" }} />
        </Box>
    )
