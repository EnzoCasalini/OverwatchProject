        ...
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ ml: 4 }}>
                ...
                <Badge
                    ...
                    badgeContent={<Avatar alt="Endorsement Level" src={playerInfo.summary.endorsement.frame} sx={{ width: 32, height: 32 }} />}
                    sx={{ mb: 1 }}
                >
                    <Avatar alt="Name Card" src={playerInfo.summary.namecard} sx={{ width: 80, height: 80 }} />
                </Badge>
